...
:::{.aside}
Check these blog entries about the eternal snows in the Cordillera de Merida: [Oryx journal blog](https://www.oryxthejournal.org/blog/vanishing-tropical-glaciers-in-venezuela-a-delicate-balance-has-been-lost/){target="otherblogs"} and the
[glacier casualty list](https://glaciercasualtylist.rice.edu/?data_id=dataSource_1-18ec41ee5e2-layer-75%3A35&dlg=ARTICLE&page=Page){target="otherblogs"}
:::
